...
function AgnesTip({ isOpen, onClose }: AgnesTipProps): React.JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        className="relative flex flex-col items-center overflow-hidden rounded-3xl bg-white shadow-2xl"
        ...
        <div className="relative flex w-full flex-col items-center px-10 pb-10 pt-12">
          <div className="mb-8 flex h-[186px] w-[221px] items-center justify-center">
            <svg width="140" height="140" viewBox="0 0 140 140" fill="none">
              <rect width="140" height="140" rx="32" fill="#EFF6FF" />
              <path
          ...
          <h2 className="mb-3 text-center text-2xl font-bold text-gray-900">欢迎使用 Agnes</h2>
          <p className="mb-8 text-center text-base leading-relaxed text-gray-500">
          ...
          <div className="mb-4 flex w-full flex-col gap-3">
            <button
              onClick={onClose}
              className="w-full cursor-pointer rounded-xl bg-blue-600 px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-blue-700"
            >
              知道了
            </button>
            <button
              onClick={onClose}
              className="w-full cursor-pointer rounded-xl px-6 py-3 text-sm font-medium text-gray-400 transition-colors hover:text-gray-600"
            >
              关闭提醒
            </button>
          </div>
